...
namespace DistributedCache_TableStorage
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            services.Configure<AzureTableStorageCacheOptions>(options =>
            {
                ...
                options.ConnectionString = "DefaultEndpointsProtocol=https;AccountName=tfpdevtsspike;AccountKey=bivU9pEjI56qLhNu3LV41QxKwwHPsZRZLE+PomD421aDBaFZFi8nIPiX3itPt2+CogHxWEblmhsR+AStFImH9w==;EndpointSuffix=core.windows.net";
